              ...
              <div class="flex">
                <span>
                  <el-tag size="large" style="font-size: 20px"
                    ><i class="el-icon-info"></i> 本月：入职 离职 调薪 未定薪</el-tag
                  >
                </span>
                <span class="shou">
                  <el-button type="danger" @click="$router.push('/setting')">设置</el-button>
                  <el-button type="primary" @click="$router.push('/statement')">202003月报表</el-button>
                </span>
              </div>
            </div>
          </div>
      ...
      <div class="list">
        <el-card class="box-card" style="height: 100%">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="departmentName" label="津贴方案" width="140">通用方案</el-table-column>
            <el-table-column label="操作" width="180">
              <template slot-scope="scope">
                <el-button type="danger" v-if="scope.row.currentBasicSalary == null" style="margin-right: 20px"
                  >定薪</el-button
                >
                <el-button type="primary" v-else style="margin-right: 20px" @click="changeSalary(scope.row.id)"
                  >调薪</el-button
                >
                <el-button type="text" @click="$router.push({ name: 'salaryDetails', params: { id: scope.row.id } })"
                  >查看</el-button
                >
              </template>
            </el-table-column>
      ...
      <el-dialog title="调薪" :visible.sync="dialogVisible" width="40%">
        <div class="dialog">
          ...
          <div class="top" style="display: flex">
            <div class="left">
              <img src="http://ihrm.itheima.net/static/img/img.0615818f.jpeg" alt="" style="width: 200px" />
            </div>
          ...
          <div class="foot">
            <el-form ref="form" :model="Salary" label-width="100px">
              <el-form-item label="调整基本工资">
                <div class="form">
                  <el-input v-model="Salary.currentBasicSalary" disabled style="width: 200px"></el-input>
                  <span style="margin: 0 20px">-></span>
                  <el-input placeholder="请输入调整后的基本工资" style="width: 200px"></el-input>
                </div>
              </el-form-item>
              <el-form-item label="调整岗位工资">
                <div class="form">
                  <el-input v-model="Salary.currentPostWage" disabled style="width: 200px"></el-input>
                  <span style="margin: 0 20px">-></span>
                  <el-input placeholder="请输入调整后的岗位工资" style="width: 200px"></el-input>
                </div>
              </el-form-item>
              <el-form-item label="工资合计">
                <div class="form">
                  <el-input v-model="Salary.currentBasicSalary" disabled style="width: 200px"></el-input>
                  <span style="margin: 0 20px">-></span>
                  <el-input disabled placeholder="0" style="width: 200px"></el-input>
                </div>
              </el-form-item>
...
<script>
import { getWagetop, getWagetable, getchangeSalary } from "@/api/salarys"
